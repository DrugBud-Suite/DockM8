...
def method1_ECR_best(df, clustering_metric, selected_columns):
    ...
    df2[f'Method1_ECR_{clustering_metric}'] = (df2[f'Method1_ECR_{clustering_metric}'] - min_score) / (max_score - min_score)
...
def method2_ECR_average(df, clustering_metric, selected_columns):
    ...
    df2[f'Method2_ECR_{clustering_metric}'] = (df2[f'Method2_ECR_{clustering_metric}'] - min_score) / (max_score - min_score)
...
def method3_avg_ECR(df, clustering_metric, selected_columns):
    ...
    df[f'Method3_ECR_{clustering_metric}'] = (df[f'Method3_ECR_{clustering_metric}'] - min_score) / (max_score - min_score)
...
def method4_RbR(df, clustering_metric, selected_columns):
    ...
    df[f'Method4_RbR_{clustering_metric}'] = (max_value - df[f'Method4_RbR_{clustering_metric}']) / (max_value - min_value)
...
def method5_RbV(df, clustering_metric, selected_columns):
    ...
    df[f'Method5_RbV_{clustering_metric}'] = (df[f'Method5_RbV_{clustering_metric}'] - min_value) / (max_value - min_value)
...
def method6_Zscore_best(df, clustering_metric, selected_columns):
    ...
    df[f'Method6_Zscore_{clustering_metric}'] = (df[f'Method6_Zscore_{clustering_metric}'] - min_value) / (max_value - min_value)
...
def method7_Zscore_avg(df, clustering_metric, selected_columns):
    ...
    df[f'Method7_Zscore_{clustering_metric}'] = (df[f'Method7_Zscore_{clustering_metric}'] - min_value) / (max_value - min_value)
