...
def ensure_software_installed(program_name):
	"""
	...
	Raises:
		ValueError: If the software path is not provided.

	Example:
		@ensure_software_installed('Python')
		def my_function(software_path):
	...
	def decorator(func):
		...
		def wrapper(*args, **kwargs):
			...
			if not is_software_installed(program_name, Path(software_path)):
				install_software(program_name, Path(software_path))
...
def is_software_installed(program_name, software_path):
	"""
	Check if the specified software is installed.

	Args:
		program_name (str): The name of the software program.
		software_path (str): The path to the software installation.
...
def install_software(program_name, software_path):
	"""
	...
	Args:
		...
		software_path (str): The path to the software.
