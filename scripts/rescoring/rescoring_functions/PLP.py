...
class PLP(ScoringFunction):
    ...
    def __init__(self, software_path: Path):
        super().__init__(
            name="PLP", column_name="PLP", best_value="min", score_range=(200, -200), software_path=software_path
        )
    ...
    def rescore(self, sdf_file: str, n_cpus: int, protein_file: str, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            plp_cmd = f"{self.software_path}/PLANTS" f" --mode rescore" f" {config_file}"
            ...
            results_csv = Path(self._temp_dir) / "results" / "ranking.csv"
