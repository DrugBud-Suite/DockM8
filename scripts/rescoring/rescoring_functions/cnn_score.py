...
class CnnScore(ScoringFunction):
    """CNN-Score scoring function implementation."""
    ...
    def rescore(self, sdf_file: Path, n_cpus: int, protein_file: Path, **kwargs) -> pd.DataFrame:
        """
        Rescore the molecules in the given SDF file using the CNN-Score scoring function.
