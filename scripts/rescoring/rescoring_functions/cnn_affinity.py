...
class CnnAffinity(ScoringFunction):
    """CNN-Affinity scoring function implementation."""
    ...
    def rescore(self, sdf_file: Path, n_cpus: int, protein_file: Path, **kwargs) -> pd.DataFrame:
        """
        Rescore the molecules in the given SDF file using the CNN-Affinity scoring function.
