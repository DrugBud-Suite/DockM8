...
def pose_buster(dataframe: pd.DataFrame, protein_file: Path, n_cpus: int = os.cpu_count()):
	...
	with ProcessPoolExecutor(max_workers=n_cpus) as executor:
		futures = [executor.submit(process_chunk, chunk, config_path, protein_file) for chunk in chunks]
