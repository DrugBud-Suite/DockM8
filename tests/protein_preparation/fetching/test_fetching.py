...
def common_test_data():
	...
	return (valid_pdb_id, invalid_pdb_id, valid_uniprot_code,
			invalid_uniprot_code, output_dir)
...
def test_fetch_pdb_structure_success(common_test_data):
    ...
    """
	(valid_pdb_id, invalid_pdb_id, valid_uniprot_code, invalid_uniprot_code,
		output_dir) = common_test_data
...
def test_fetch_alphafold_structure_failure(common_test_data):
	...
	(valid_pdb_id, invalid_pdb_id, valid_uniprot_code, invalid_uniprot_code,
		output_dir) = common_test_data
	with pytest.raises(Exception):
		output_path = fetch_alphafold_structure(invalid_uniprot_code,
												output_dir)
		assert not output_path.exists()
