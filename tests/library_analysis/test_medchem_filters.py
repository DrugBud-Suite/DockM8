...
from scripts.library_analysis.medchem_filters import apply_medchem_rules
...
def test_apply_medchem_rules(common_test_data):
	...
	selected_rules = ['rule_of_five']

	# Call the function to apply MedChem rules
	filtered_df, num_filtered, num_remaining = apply_medchem_rules(df, selected_rules, n_cpus=2)
