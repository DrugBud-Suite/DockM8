...
def test_prepare_library_protonation(common_test_data, cleanup):
    ...
    final_library = prepare_library(library, output_dir, id_column, "GypsumDL",
                                    "GypsumDL", software, n_cpus)
    ...
    input_df = PandasTools.LoadSDF(str(library),
                                   molColName=None,
                                   idName=id_column)
    final_library = PandasTools.LoadSDF(str(final_library),
                                        molColName=None,
                                        idName=id_column)
...
def test_prepare_library_no_protonation(common_test_data, cleanup):
    ...
    library, output_dir, id_column, software, n_cpus = common_test_data
    final_library = prepare_library(library, output_dir, id_column, "None",
                                    "GypsumDL", software, n_cpus)
    expected_output = output_dir / "final_library.sdf"
    # Check if the final library file exists
    assert final_library == expected_output
...
def test_prepare_library_invalid_protonation(common_test_data, cleanup):
    ...
    with pytest.raises(ValueError):
        prepare_library(library, output_dir, id_column, "InvalidMethod",
                        "GypsumDL", software, n_cpus)
...
def test_prepare_library_invalid_conformers(common_test_data, cleanup):
    ...
    with pytest.raises(ValueError):
        prepare_library(library, output_dir, id_column, "GypsumDL",
                        "InvalidMethod", software, n_cpus)
