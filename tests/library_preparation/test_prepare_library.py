...
def test_prepare_library_protonation(common_test_data, cleanup):
    ...
    # Call the function
    final_df = prepare_library(library, "ID", "GypsumDL", "GypsumDL", software, n_cpus)
...
def test_prepare_library_no_protonation(common_test_data, cleanup):
    ...
    # Call the function
    final_df = prepare_library(library, "ID", "None", "GypsumDL", software, n_cpus)
...
def test_prepare_library_invalid_protonation(common_test_data, cleanup):
    ...
    with pytest.raises(ValueError):
        prepare_library(library, "ID", "InvalidMethod", "GypsumDL", software, n_cpus)
...
def test_prepare_library_invalid_conformers(common_test_data, cleanup):
    ...
    with pytest.raises(ValueError):
        prepare_library(library, "ID", "GypsumDL", "InvalidMethod", software, n_cpus)