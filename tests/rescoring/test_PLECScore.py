# =============================================================================
# PLECScore tests - REMOVED FROM PUBLICATION
# PLECScore scoring function is known to be broken and has been disabled.
...
#
#
# def test_PLECScore_rescoring(test_data):
#     protein_file, software, sdf, n_cpus, output_dir = test_data
#
#     plecscore = PLECScore(software)
#
#     result = plecscore.rescore(sdf, n_cpus, protein_file=protein_file)
#
#     assert isinstance(result, DataFrame)
#     assert "Pose ID" in result.columns
#     assert plecscore.column_name in result.columns
#     assert len(result) > 0
#
...
#
#     output_file = output_dir / f"{plecscore.column_name}_scores.csv"
